...
<body ng-app="TradeServices" style="font-size: 13px">
...
<script type="text/javascript">
	...
	var app = angular.module("TradeServices", ['ngRoute', 'ngTouch','ui.grid', 'ui.grid.resizeColumns', 'ui.grid.pagination', 'TradeServices.services'])
		.config(['$routeProvider', function($routeProvider) {
  			$routeProvider
				...
				.when("/callback", {templateUrl: "resources/jsp/callback.jsp", controller: "callbackController"})
...
<script src="resources/services/services.js"></script>
...
<script src="resources/controllers/callback-controller.js"></script>
