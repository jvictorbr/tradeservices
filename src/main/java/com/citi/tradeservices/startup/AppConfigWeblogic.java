...
@Profile("Weblogic")
public class AppConfigWeblogic {
	
	private static final transient Logger log = Logger.getLogger(AppConfigTomcat.class);
	...
	public DataSource dataSource() {
        ...
        try {
            dataSource = (DataSource) jndi.lookup("jdbc/TradeDS");
        } catch (NamingException e) {
            log.error("NamingException for jdbc/TradeDS", e);
        }
        return dataSource;
	}
