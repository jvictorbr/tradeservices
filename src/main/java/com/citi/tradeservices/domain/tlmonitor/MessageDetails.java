...
public class MessageDetails implements Serializable {
	...
	public boolean equals(Object other) { 
        ...
        if ( !(other instanceof MessageDetails) ) return false;

        final MessageDetails otherMessage = (MessageDetails) other;

        return otherMessage.getRequestId().equals(this.getRequestId()) && otherMessage.getMessageType().equals(this.getMessageType());

	}
	
	@Override
	public int hashCode() { 
		int hashCode = getRequestId().hashCode();
		hashCode = 29 * hashCode + getMessageType().hashCode();
		return hashCode;
	}
